...
import BasicTable, { basicTableI, matchHistoryRowI, playerStatisticsRowI, rowI } from "src/components/BasicTable/BasicTable";
...
const AccountPage: FC<any> = (): ReactElement => {
  ...
  return (
    <Box
      ...
      <SignUp />
      <Box></>
      <BasicTable title="Settings" tableHeadArray={null} tableRowArray={playerRows}/>
      <BasicTable title="Player stats" tableHeadArray={null} tableRowArray={playerRows}/>   
      <BasicTable title="Match history" tableHeadArray={header} tableRowArray={historyRows}/>   
      </Box>
  );
};
